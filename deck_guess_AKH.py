...
deck_guess = {
    ...
    'UR Control': {'Torrential Gearhulk':4, 'Glimmer of Genius':4,
                   'Harnessed Lightning':4, 'Spirebluff Canal':4, 'Wandering Fumarole':4,
                   'Void Shatter':4, 'Anticipate':4, 'Negate':4, 'Galvanic Bombardment':4, 
                   "Disallow": 4,
                   'Magma Spray': 4,
                   'Censor':4},
    'UR Dynavolt Control': {'Torrential Gearhulk':2, 'Glimmer of Genius':4,
                            'Harnessed Lightning':4, 'Spirebluff Canal':4, 'Wandering Fumarole':4,
                            'Magma Spray': 4,
                            'Void Shatter':4, 'Anticipate':4, 'Negate':4, 'Galvanic Bombardment':4,
                            'Dynavolt Tower':2},
    'RUG Dynavolt Control': {'Torrential Gearhulk':2, 'Glimmer of Genius':4,
                             'Harnessed Lightning':4, 'Spirebluff Canal':4, 'Wandering Fumarole':4,
                             'Rogue Refiner': 4, 'Shielded Aether Thief': 3,
                             'Attune with Aether': 4,
                             'Magma Spray': 4,
                             'Botanical Sanctum': 4,
                             'Lumbering Falls': 2,
                             'Void Shatter':4, 'Anticipate':4, 'Negate':4,
                             'Dynavolt Tower':2},
    'Jeskai Control': {'Torrential Gearhulk':2, 'Glimmer of Genius':4,
                       ...
                       'Harnessed Lightning':4, 'Spirebluff Canal':4, 'Wandering Fumarole':4,
                       'Void Shatter':4, 'Anticipate':4, 'Negate':4, 'Galvanic Bombardment':4},
    'Mono-B Zombies': {'Lord of the Accursed': 4, 'Dread Wanderer':4, "Liliana's Mastery":4, "Crypt Breaker": 4,
                       'Diregraf Colossus': 4, 'Dark Salvation': 4,},
    'BW Zombies': {'Diregraf Colossus': 4, 'Binding Mummy': 4, 'Wayward Servant': 4, 'Dark Salvation': 4,},
    ...
    'UR Graveyard Emerge': {'Elder Deep-Fiend':4, "Kozilek's Return":4,
                            "Prized Amalgam":4, "Cathartic Reunion":4,
                            "Advanced Stitchwing":3,
                            "Stitchwing Skaab":4, "Wretched Gryff":1},
    'BG Counters': {'Verdurous Gearhulk':4, 'Rishkar, Peema Renegade': 4, 'Winding Constrictor': 4, 'Walking Ballista':4,
                    "Scrapheap Scrounger":4, "Nissa, Voice of Zendikar":4, "Sylvan Advocate":4},
    'BG Delirium': {'Verdurous Gearhulk':1, 'Rishkar, Peema Renegade': 2, 'Winding Constrictor': 4,
                    'Walking Ballista':4,
                    'Grim Flayer':4, 'Traverse the Ulvenwald': 4},
    'BG Energy': {'Verdurous Gearhulk':4, 'Rishkar, Peema Renegade': 4,
                  'Winding Constrictor': 4, 'Glint-Sleeve Siphoner':4, 'Walking Ballista':4,
                  'Greenbelt Rampager':4, 'Longtusk Cub':4, "Servant of the Conduit":4},
    'GW Tokens': {'Gideon, Ally of Zendikar':4, 'Nissa, Voice of Zendikar':4, 'Archangel Avacyn': 4, },
    'RB Aggro': {"Weldfast Engineer":3, "Foreboding Ruins":4,
    ...
    'Mardu Ballista': {#"Cultivator's Caravan":3, "Concealed Courtyard":4,
                       "Scrapheap Scrounger":4, "Heart of Kiran":4,
                       "Walking Ballista":4,
                       "Unlicensed Disintegration": 4,
    ...
    #                         },
    'Temur Aetherworks Marvel': {'Aetherworks Marvel':4, 'Ulamog, the Ceaseless Hunger':4,
    ...
    'BUG Aetherworks Marvel': {'Aetherworks Marvel':4, 'Ulamog, the Ceaseless Hunger':2,
                               'Attune with Aether':4, 'Vessel of Nascency':4,
                               'Forest':8, 'Swamp':4,
                               "Liliana, Death's Majesty": 2,
                               "Ishkanah, Grafwidow": 2,
                               'Demon of Dark Schemes':2, 'Noxious Gearhulk':2, 'Grasp of Darkness':2, 'Blooming Marsh':2,
